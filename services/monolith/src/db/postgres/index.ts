...
export const startPgPoolMetrics = () => {
	setInterval(() => {
		// INFO: pg.Pool API: totalCount = all connections; idleCount = available,
	...
	}, 15_000).unref(); // poll db pool every 15s
};
